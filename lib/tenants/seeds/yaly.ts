...
export const yalySeed: TenantSeed = {
  ...
  staff: [
    ...
    { id: "s2", nombre: "Renata Alvarenga", rol: "medico", departamento: "reservas", iniciales: "RA" },
    { id: "s3", nombre: "Óscar Menjívar", rol: "recepcion", departamento: "recepcion", iniciales: "OM" },
    { id: "s4", nombre: "Claudia Bonilla", rol: "jefe", departamento: "reservas", iniciales: "CB" },
    { id: "s5", nombre: "Iván Portillo", rol: "medico", departamento: "conserjeria", iniciales: "IP" },
    { id: "s6", nombre: "Gabriela Nieto", rol: "recepcion", departamento: "atencion", iniciales: "GN" },
  ],
  contacts: [
  ...
  internalChannels: [
    ...
    { id: "ic4", nombre: "eventos", tipo: "canal", miembros: [ME, "s4", "s5"] },
    { id: "dm1", nombre: "Claudia Bonilla", tipo: "dm", miembros: [ME, "s4"] },
    { id: "dm2", nombre: "Óscar Menjívar", tipo: "dm", miembros: [ME, "s3"] },
  ],
  internalMessages: [
